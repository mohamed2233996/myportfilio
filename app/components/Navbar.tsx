...
const Navbar = () => {
    return (
        <nav className="w-full max-w-7xl flex flex-col md:flex-row justify-between items-center gap-6 mb-20 md:mb-32 text-[11px] md:text-[13px] font-medium uppercase tracking-tighter transition-colors duration-500">
            ...
            <div className="flex items-center gap-4">
                <span className="hidden sm:inline text-gray-400 dark:text-gray-500">LET'S CONNECT</span>
    ...
    <span className="text-gray-400 cursor-pointer hover:text-white dark:hover:text-white transition">❐</span>
</div>
            </div>
